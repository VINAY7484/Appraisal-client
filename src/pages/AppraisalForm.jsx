...
const AppraisalForm = ({ id, field, onClose }) => {
    ...
    const fetchAppraisalQuestion = async () => {
        ...
        try {
            if (field === "view") {
                const response = await axios.get(`${baseURL}/appraisal-form/${id}`, {
                    headers: {
                ...
                <table className="w-full rounded-2xl overflow-x-hidden mt-8">
                    <thead>
                        <tr className="bg-gray-100 p-2 h-10">
                            <th className="text-center px-2 border w-[5vw]">Sr. No</th>
                            <th className="text-center px-2 border">Question</th>
                            <th className="text-center px-2 border w-[5vw]">Rating</th>
                            <th className="text-center px-2 border w-[10vw]">Remark</th>
